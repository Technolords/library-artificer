 ...
 */
public class BytecodeManagerTest extends TestSupport {
    private static final Logger LOGGER = LoggerFactory.getLogger(BytecodeManagerTest.class);
    ...
    public void testAnalyseBytecodeForSingleClass() throws Exception {
        ...
        BytecodeManager bytecodeManager = new BytecodeManager(KNOWN_JAVA_SPECIFICATIONS_REFERENCE_FILE);
        bytecodeManager.analyseBytecode(resource);
    }
}