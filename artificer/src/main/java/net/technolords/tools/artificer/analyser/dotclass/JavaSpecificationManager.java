 ...
 */
public class JavaSpecificationManager {
    private static final Logger LOGGER = LoggerFactory.getLogger(JavaSpecificationManager.class);
     ...
     */
    public JavaSpecificationManager(String referenceFile) {
